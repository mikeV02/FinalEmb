...
//void CSpider::MoveTripod(TRIPOD_ID Tripod,CSpiderLeg::JOINT_ID Joint,float AngleF,float AngleM,float AngleB)
void CSpider::SnowAngel(uint8_t Repeat_Num)
{
	if (m_bDebugDump)
	  printf("SnowAngel \n");
	int num=0;
	...
	for(num=0;num<Repeat_Num;num++)
	{
		for(int j=0; j<360; j++){
			SetSpeed(log(j)*10);
			double c = cos((j*3.14159265)/180)*30;
			double s = sin((j*3.14159265)/180)*20;
			//s= abs(s);
			MoveTripod(TRIPOD1,CSpiderLeg::Hip,HipF_Base+c,HipM_Base+c,HipB_Base+c);
			MoveTripod(TRIPOD2,CSpiderLeg::Hip,HipF_Base+c,HipM_Base+c,HipB_Base+c);
			MoveTripod(TRIPOD1,CSpiderLeg::Ankle,Ankle_Straight+s,Ankle_Straight+s,Ankle_Straight+s);
			MoveTripod(TRIPOD2,CSpiderLeg::Ankle,Ankle_Straight+s,Ankle_Straight+s,Ankle_Straight+s);
			WaitReady(ReadyTime());
...
void CSpider::Flatten()
{
	if (m_bDebugDump)
	  printf("Flattening\n");
	SetSpeed(10);
  MoveTripod(TRIPOD1,CSpiderLeg::Ankle,Ankle_Base-130,Ankle_Base-130,Ankle_Base-130);
  MoveTripod(TRIPOD2,CSpiderLeg::Ankle,Ankle_Base-130,Ankle_Base-130,Ankle_Base-130);
  WaitReady(ReadyTime());		  
  MoveTripod(TRIPOD1,CSpiderLeg::Knee,Knee_Up_Base,Knee_Up_Base,Knee_Up_Base);
  MoveTripod(TRIPOD2,CSpiderLeg::Knee,Knee_Up_Base,Knee_Up_Base,Knee_Up_Base);
  WaitReady(ReadyTime());			  
}
void CSpider::AnkleStance(int ankleOffset)
{
	if (m_bDebugDump)
	  printf("Squaring\n");
	SetSpeed(70);
	MoveTripod(TRIPOD1,CSpiderLeg::Knee,Knee_Down_Base,Knee_Down_Base,Knee_Down_Base);
	MoveTripod(TRIPOD2,CSpiderLeg::Knee,Knee_Down_Base,Knee_Down_Base,Knee_Down_Base);
	MoveTripod(TRIPOD1,CSpiderLeg::Ankle,Ankle_Base-10,Ankle_Base-10,Ankle_Base-10);
	MoveTripod(TRIPOD2,CSpiderLeg::Ankle,Ankle_Base-10,Ankle_Base-10,Ankle_Base-10);
	WaitReady(ReadyTime());
	MoveTripod(TRIPOD1,CSpiderLeg::Knee,0,0,0);
	MoveTripod(TRIPOD2,CSpiderLeg::Knee,0,0,0);
	WaitReady(ReadyTime());
	
	MoveTripod(TRIPOD1,CSpiderLeg::Knee,Knee_Up_Base,Knee_Up_Base,Knee_Up_Base);
	MoveTripod(TRIPOD1,CSpiderLeg::Ankle,Ankle_Straight+ankleOffset,Ankle_Straight+ankleOffset,Ankle_Straight+ankleOffset);
	WaitReady(ReadyTime());
	MoveTripod(TRIPOD1,CSpiderLeg::Knee,0,0,0);
	WaitReady(ReadyTime());
	
	MoveTripod(TRIPOD2,CSpiderLeg::Knee,Knee_Up_Base,Knee_Up_Base,Knee_Up_Base);
	MoveTripod(TRIPOD2,CSpiderLeg::Ankle,Ankle_Straight+ankleOffset,Ankle_Straight+ankleOffset,Ankle_Straight+ankleOffset);
	WaitReady(ReadyTime());
	MoveTripod(TRIPOD2,CSpiderLeg::Knee,0,0,0);    
	WaitReady(ReadyTime());	  	
}

void CSpider::ArmSway(uint8_t Repeat_Num)
{
	int hipSway = 20;
	int ankleSway = 60;
	if (m_bDebugDump)
	...
	SetSpeed(30);
	//TiltBackward();
	//m_szLeg[LEG_LB]->MoveJoint(CSpiderLeg::Knee,20);
	//m_szLeg[LEG_RB]->MoveJoint(CSpiderLeg::Knee,20);	
	m_szLeg[LEG_LB]->MoveJoint(CSpiderLeg::Hip,HipM_Base-hipSway);
	m_szLeg[LEG_RB]->MoveJoint(CSpiderLeg::Hip,HipM_Base-hipSway);
	WaitReady(ReadyTime());
	m_szLeg[LEG_LM]->MoveJoint(CSpiderLeg::Hip,HipM_Base+hipSway);
	m_szLeg[LEG_RM]->MoveJoint(CSpiderLeg::Hip,HipM_Base+hipSway);
	WaitReady(ReadyTime());
	m_szLeg[LEG_LF]->MoveJoint(CSpiderLeg::Knee,Knee_Up_Base);
	m_szLeg[LEG_LF]->MoveJoint(CSpiderLeg::Ankle,Ankle_Straight);
	m_szLeg[LEG_RF]->MoveJoint(CSpiderLeg::Knee,Knee_Up_Base);
	m_szLeg[LEG_RF]->MoveJoint(CSpiderLeg::Ankle,Ankle_Straight);	
	...
	{				
		SetSpeed(30);
		m_szLeg[LEG_LF]->MoveJoint(CSpiderLeg::Hip,HipF_Base-hipSway);
		m_szLeg[LEG_RF]->MoveJoint(CSpiderLeg::Hip,HipF_Base+hipSway);
		SetSpeed(80);
		m_szLeg[LEG_LF]->MoveJoint(CSpiderLeg::Ankle,Ankle_Straight+ankleSway);		
		m_szLeg[LEG_RF]->MoveJoint(CSpiderLeg::Ankle,Ankle_Straight+ankleSway);		
		WaitReady(ReadyTime());		
	...
	SetSpeed(30);
	m_szLeg[LEG_LB]->MoveJoint(CSpiderLeg::Hip,HipM_Base);
	m_szLeg[LEG_RB]->MoveJoint(CSpiderLeg::Hip,HipM_Base);
	WaitReady(ReadyTime());	
	m_szLeg[LEG_LM]->MoveJoint(CSpiderLeg::Hip,HipM_Base);
	m_szLeg[LEG_RM]->MoveJoint(CSpiderLeg::Hip,HipM_Base);
	WaitReady(ReadyTime());	
	m_szLeg[LEG_LF]->MoveJoint(CSpiderLeg::Hip,HipM_Base);
	m_szLeg[LEG_RF]->MoveJoint(CSpiderLeg::Hip,HipM_Base);
	WaitReady(ReadyTime());	
	

}
void CSpider::WaveFlutter(uint8_t Repeat_Num)
{
	Flatten();
	//WaitReady(ReadyTime());  	
	int raiseAmount=30;	
	...
	{				
		SetSpeed(70);
		for(int i=0; i<360; i++){
			m_szLeg[LEG_RM]->MoveJoint(CSpiderLeg::Knee,raiseAmount*(sin((i*3.14159265)/180)+1));
			m_szLeg[LEG_RB]->MoveJoint(CSpiderLeg::Knee,raiseAmount*(sin(((i+60)*3.14159265)/180)+1));
			m_szLeg[LEG_LB]->MoveJoint(CSpiderLeg::Knee,raiseAmount*(sin(((i+120)*3.14159265)/180)+1));
			m_szLeg[LEG_LM]->MoveJoint(CSpiderLeg::Knee,raiseAmount*(sin(((i+180)*3.14159265)/180)+1));
			m_szLeg[LEG_LF]->MoveJoint(CSpiderLeg::Knee,raiseAmount*(sin(((i+240)*3.14159265)/180)+1));
			m_szLeg[LEG_RF]->MoveJoint(CSpiderLeg::Knee,raiseAmount*(sin(((i+300)*3.14159265)/180)+1));
			WaitReady(ReadyTime());
		}
	}		
...
void CSpider::BestDance(uint8_t Repeat_Num)
{
