...
//	bool WaitReady(float fTimeoutSecond);
	...
	void Sleep(void);
	void WakeUp(void);
	void SnowAngel(uint8_t Repeat_Num);
	void Flatten(void);
	void AnkleStance(int ankleOffset);
	void ArmSway(uint8_t Repeat_Num);
	void WaveFlutter(uint8_t Repeat_Num);
	void BestDance(uint8_t Repeat_Num);
};
